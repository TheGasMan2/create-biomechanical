...
public class CogolemModel extends GeoModel<CogolemEntity> {
    ...
    public ResourceLocation getModelResource(CogolemEntity animatable) {
        return new ResourceLocation(CreateBiomechanical.MODID, "geo/cogolem.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(CogolemEntity animatable) {
        return new ResourceLocation(CreateBiomechanical.MODID, "textures/entity/cogolem.png");
    }

    @Override
    public ResourceLocation getAnimationResource(CogolemEntity animatable) {
        return new ResourceLocation(CreateBiomechanical.MODID, "animations/cogolem.animation.json");
    }
