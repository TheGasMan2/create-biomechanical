package net.thegasman.createmechanisedmenagerie.entity.custom;
...
public class CogolemEntity extends PathfinderMob implements GeoEntity {
    ...
    private <T extends GeoAnimatable> PlayState predicate(AnimationState<T> tAnimationState) {
        ...
        System.out.println("State: Attacking = " + this.isAttacking() + ", Chasing = " + this.isChasing());
        System.out.println("Current Animation: " + controller.getCurrentAnimation());
